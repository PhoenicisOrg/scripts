...
Wine.prototype.xact = function () {
    const extractFiles = (progressBar, filesToExtract, destination, pattern, directory) => {
        ...
        filesToExtract.reduce((numberOfExtractedFiles, cabFile) => {
            ...
            new CabExtract()
                .archive(this.prefixDirectory() + "/drive_c/" + directory + cabFile)
                .to(destination)
                .extract(["-L", "-F", pattern]);
    ...
    const regsvr32Xact = (progressBar, dllToRegsvr) => {
    ...
    extractFiles(progressBar, filesToExtract, this.system32directory(), "xactengine*.dll", "xact_x86/");
    ...
    extractFiles(progressBar, filesToExtract, this.system32directory(), "X3Daudio*.dll", "x3daudio_x86/");
    ...
    extractFiles(progressBar, filesToExtract, this.system32directory(), "XAudio*.dll", "xaudio_x86/");
    extractFiles(progressBar, filesToExtract, this.system32directory(), "XAPOFX*.dll", "xaudio_x86/");
    ...
    if (this.architecture() == "amd64") {
        ...
        extractFiles(progressBar, filesToExtract, this.system64directory(), "xactengine*.dll", "xact_x64/");
        ...
        extractFiles(progressBar, filesToExtract, this.system64directory(), "X3Daudio*.dll", "x3daudio_x64/");
        ...
        extractFiles(progressBar, filesToExtract, this.system64directory(), "XAudio*.dll", "xaudio_x64/");
        extractFiles(progressBar, filesToExtract, this.system64directory(), "XAPOFX*.dll", "xaudio_x64/");
...
module.default = class XactVerb {
    ...
    install(container) {
        ...
        const wizard = SetupWizard(InstallationType.VERBS, "xact", java.util.Optional.empty());
        wine.wizard(wizard);
        wine.xact();
